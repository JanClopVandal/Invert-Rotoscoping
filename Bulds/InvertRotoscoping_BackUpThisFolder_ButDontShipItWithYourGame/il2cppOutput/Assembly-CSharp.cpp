...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Swimmer_FixedUpdate_mCFF285235637E907057C1298C5F14FDFB21D1CE6 (Swimmer_t2FEE916089BFA96DB067991A514771BAFF2178DE* __this, const RuntimeMethod* method) 
{
	...
	{
		// tex.text = Convert.ToString(leftControllerVelocity.action.ReadValue<Vector3>());
		TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9* L_0 = __this->___tex_17;
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_1 = __this->___leftControllerVelocity_9;
		NullCheck(L_1);
		...
		ActionBasedController_tB9D8E7E013191571EA5507EA68057414B6969A68* L_7 = __this->___leftcontroller_13;
		NullCheck(L_7);
		...
		L_9 = InputActionProperty_get_action_mABF2197D9CC6586E5DFB0481CF9C1B2586F41A47((&V_3), NULL);
		NullCheck(L_9);
		float L_10;
		...
		bool L_11;
		L_11 = Convert_ToBoolean_m73A44AA68F53847BAC4B938953612587F8FBF61B(L_10, NULL);
		V_0 = L_11;
		// bool rightHandPress = Convert.ToBoolean(rightcontroller.selectAction.action.ReadValue<float>());
		ActionBasedController_tB9D8E7E013191571EA5507EA68057414B6969A68* L_12 = __this->___rightcontroller_14;
		NullCheck(L_12);
		...
		L_14 = InputActionProperty_get_action_mABF2197D9CC6586E5DFB0481CF9C1B2586F41A47((&V_3), NULL);
		NullCheck(L_14);
		float L_15;
		...
		bool L_16;
		L_16 = Convert_ToBoolean_m73A44AA68F53847BAC4B938953612587F8FBF61B(L_15, NULL);
		V_1 = L_16;
		// _cooldownTimer += Time.fixedDeltaTime;
		float L_17 = __this->____cooldownTimer_21;
		float L_18;
		L_18 = Time_get_fixedDeltaTime_m43136893D00AF5D5FE80AD05609558F6E2381381(NULL);
		__this->____cooldownTimer_21 = ((float)il2cpp_codegen_add(L_17, L_18));
		...
		float L_19 = __this->____cooldownTimer_21;
		float L_20 = __this->___minTimeBetweenStrokes_7;
		bool L_21 = V_0;
		bool L_22 = V_1;
		if (!((int32_t)(((int32_t)(((((float)L_19) > ((float)L_20))? 1 : 0)&(int32_t)L_21))&(int32_t)L_22)))
		{
			goto IL_00e3;
		}
	}
	{
		bool L_23 = __this->___leftHandOnGround_18;
		if (!L_23)
		{
			goto IL_00e3;
		}
	...
	{
		bool L_24 = __this->___rightHandOnGround_19;
		if (!L_24)
		{
			goto IL_00e3;
		}
	}
	{
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_25 = __this->___leftControllerVelocity_9;
		NullCheck(L_25);
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_28 = __this->___rightControllerVelocity_11;
		NullCheck(L_28);
		...
		L_30 = InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE(L_29, InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE_RuntimeMethod_var);
		V_4 = L_30;
		...
		L_34 = Vector3_op_Multiply_m87BA7C578F96C8E49BB07088DAAC4649F83B0353_inline(L_33, (-1.0f), NULL);
		V_2 = L_34;
		// ForvardForce(loaclVelocity);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_35 = V_2;
		Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1(__this, L_35, NULL);
		// RevertForce();
...
IL_00e3:
	{
		...
		//     && leftHandPress
		//     && leftHandOnGround)
		float L_36 = __this->____cooldownTimer_21;
		float L_37 = __this->___minTimeBetweenStrokes_7;
		bool L_38 = V_0;
		if (!((int32_t)(((((float)L_36) > ((float)L_37))? 1 : 0)&(int32_t)L_38)))
		{
			goto IL_0128;
		}
	}
	{
		bool L_39 = __this->___leftHandOnGround_18;
		if (!L_39)
		{
			goto IL_0128;
		}
	}
	{
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_40 = __this->___leftControllerVelocity_9;
		NullCheck(L_40);
...
IL_0128:
	{
		...
		//     && rightHandPress
		//     && rightHandOnGround)
		float L_46 = __this->____cooldownTimer_21;
		float L_47 = __this->___minTimeBetweenStrokes_7;
		bool L_48 = V_1;
		if (!((int32_t)(((((float)L_46) > ((float)L_47))? 1 : 0)&(int32_t)L_48)))
		{
			goto IL_016c;
		}
	}
	{
		bool L_49 = __this->___rightHandOnGround_19;
		if (!L_49)
		{
			goto IL_016c;
		}
	}
	{
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_50 = __this->___rightControllerVelocity_11;
		NullCheck(L_50);
		...
		L_52 = InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE(L_51, InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE_RuntimeMethod_var);
		V_2 = L_52;
		// loaclVelocity *= -2;
		...
		Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1(__this, L_55, NULL);
		// RevertForce();
		Swimmer_RevertForce_mF1F358F8CF49DDD51FBA6308865EE6634871D88A(__this, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1 (Swimmer_t2FEE916089BFA96DB067991A514771BAFF2178DE* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___loaclVelocity0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_6 = __this->____rigidbody_20;
