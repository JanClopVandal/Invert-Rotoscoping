...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Swimmer_FixedUpdate_mCFF285235637E907057C1298C5F14FDFB21D1CE6 (Swimmer_t2FEE916089BFA96DB067991A514771BAFF2178DE* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1(__this, L_28, NULL);
		// RevertForce();
...
IL_00be:
	{
		...
		//     && leftHandPress
		//     && leftHandOnGround)
		float L_29 = __this->____cooldownTimer_20;
		float L_30 = __this->___minTimeBetweenStrokes_7;
		bool L_31 = V_0;
		if (!((int32_t)(((((float)L_29) > ((float)L_30))? 1 : 0)&(int32_t)L_31)))
		{
			goto IL_0103;
		}
	}
	{
		bool L_32 = __this->___leftHandOnGround_17;
		if (!L_32)
		{
			goto IL_0103;
		}
	}
	{
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_33 = __this->___leftControllerVelocity_9;
		NullCheck(L_33);
		...
		L_35 = InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE(L_34, InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE_RuntimeMethod_var);
		V_2 = L_35;
		// loaclVelocity *= -2;
		...
		Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1(__this, L_38, NULL);
		// RevertForce();
		Swimmer_RevertForce_mF1F358F8CF49DDD51FBA6308865EE6634871D88A(__this, NULL);
		return;
	}
...
IL_0103:
	{
		...
		//     && rightHandPress
		//     && rightHandOnGround)
		float L_39 = __this->____cooldownTimer_20;
		float L_40 = __this->___minTimeBetweenStrokes_7;
		bool L_41 = V_1;
		if (!((int32_t)(((((float)L_39) > ((float)L_40))? 1 : 0)&(int32_t)L_41)))
		{
			goto IL_0147;
		}
	}
	{
		bool L_42 = __this->___rightHandOnGround_18;
		if (!L_42)
		{
			goto IL_0147;
		}
	}
	{
		...
		InputActionReference_t64730C6B41271E0983FC21BFB416169F5D6BC4A1* L_43 = __this->___rightControllerVelocity_11;
		NullCheck(L_43);
		...
		L_45 = InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE(L_44, InputAction_ReadValue_TisVector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2_m30270520598CDB38962B8367F8AA1B67B79174DE_RuntimeMethod_var);
		V_2 = L_45;
		// loaclVelocity *= -2;
		...
		Swimmer_ForvardForce_m7B8E6C3E9919C247B35984137340A4949D505BF1(__this, L_48, NULL);
		// RevertForce();
		Swimmer_RevertForce_mF1F358F8CF49DDD51FBA6308865EE6634871D88A(__this, NULL);
	}
